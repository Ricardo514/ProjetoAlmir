...
<body>
    ...
    <div class="container teal lighten-5 black-text col s12">
        ...
        <div class="row">
            <form action="recinscliente.php" method="POST" id="frminsLivro" class="col s12">
                <div class="input-field col s8">
                    <input id="nome" type="text" name="txtNome">
                    <label for="nome" class="black-text bold">Nome</label>
                </div>
                <div class="input-field col s8">
                    <input id="Cod" type="text" name="txtLivro">
                    <label for="aniversario" class="black-text bold">Código do Livro comprado</label>
                </div>
                <div class="input-field col s8">
                    <input id="total" type="text" name="txtTotal">
