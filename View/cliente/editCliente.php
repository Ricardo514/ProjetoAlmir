...
<?php  include_once 'C:\xampp\htdocs\servicos\menu.php' ?>
    <div class="container teal lighten-5 black-text col s12">
        <div class="center grey grey">
            <h1>Editar Informações  Cliente</h1>
        </div>

        <div class="row">
            <form action="recedCliente.php" method="POST" id="" class="col s12">
                ...
                <div class="input-field col s8">
                    <input id="id-livro" type="text" name="txtLivro" value="<?php echo $cliente->getLivro() ?>">
                    <label for="data" class="black-text bold">Id do livro </label>
                </div>
                <div class="input-field col s8">
                    <input id="total" type="text" name="txtTotal" value="<?php echo $cliente->getTotal() ?>">
                    <label for="total" class="black-text bold">Total</label>
                </div>
